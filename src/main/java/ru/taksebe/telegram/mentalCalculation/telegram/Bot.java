...
public final class Bot extends TelegramLongPollingCommandBot {
    ...
    public Bot(String botName, String botToken) {
        ...
        logger.debug("Реализованные проекты");
        register(new Progress("progress", "Проекты в работе"));
        logger.debug("Проекты в работе");
        register(new Contacts("contacts", "Контакты"));
        logger.debug("Контакты");
