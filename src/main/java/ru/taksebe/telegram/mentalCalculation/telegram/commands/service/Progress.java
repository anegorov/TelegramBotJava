 ...
 */
public class Progress extends ServiceCommand {
    private Logger logger = LoggerFactory.getLogger(Progress.class);

    public Progress(String identifier, String description) {
